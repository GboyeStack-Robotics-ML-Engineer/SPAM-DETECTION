...
def train_model(df, input_col, target_col, hyperparameters,mode):
    ...
    train_loss = torch.randn(size=(1,10))
    train_accuracy =torch.randint(1,11,size=(1,10))
...
def app():    
    ...
    with tab3:
        ...
        if st.button('START TRAINING'):
            ...
            try:
                metrics_df = train_model(data, input_col, target_col, hyperparameters,mode='TRAIN')
    ...
    with tab4:
        ...
        try:
            ...
            # try:
            #     metrics_df = train_model(data, input_col, target_col, hyperparameters,mode='VALID')
                
            # except Exception as e:
                
            #     st.error(f"An error occurred: {e}")
            #     pass  
            metrics_df=metrics.get_metrics()
